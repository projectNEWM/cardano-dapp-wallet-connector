...
**`signTransaction: (tx: string, callback: (signedTx: string) => undefined, options?: SignTxOptions) => undefined`**
...
**`signWalletTransaction: (wallet: Wallet, tx: string, options?: SignTxOptions) => Promise<string>`**
